...
public class DB_Conexao extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS Gastos (ID INTEGER PRIMARY KEY AUTOINCREMENT, Categoria TEXT, Nome TEXT, Data TEXT, Valor TEXT NOT NULL);";
